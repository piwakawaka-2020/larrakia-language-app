  ...
  return knex('words').del()
    .then(function () {
      return knex('words').insert([
        ...
        {gulumirrgin_word: 'Danggalaba', english_word: 'Saltwater Crocodile', category: 'animals', audio_url: '/audio/Dangalaba_vMemo.mp4', image_url: '/images/Dangalaba.jpg' },
        ...
        {gulumirrgin_word: 'Birrdibirripba', english_word: 'dragonfly', category: 'animals', image_url: '/images/Birrdibirripba.jpg' },
