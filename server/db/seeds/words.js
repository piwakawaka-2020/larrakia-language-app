  ...
  return knex('words').del()
    .then(function () {
      return knex('words').insert([
        ...
        {gulumirrgin_word: 'Bilirrawarra', english_word: 'Black Cockatoos', category: 'animals', audio_url:'/audio/Biliwarra_Edited.mp4', image_url: '/images/Bilirrawarra.jpg' },
        ...
        {gulumirrgin_word: 'Mindimilma', english_word: 'Native pink apple', category: 'Fruits\'n\'Veg', audio_url: '/audio/Mindimila_Edited.mp4', image_url: '/images/Mindimilma.jpg' },
